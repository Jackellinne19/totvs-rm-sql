...
CASE
    ...
    WHEN TIPO_FUND = 'FUND1' AND EH_MAT_LPL IN (1,2) THEN
        (
            (
...
FROM   (SELECT DISTINCT SDISCIPLINA.NOME             AS NOME_DISC,
                       ...
                       MAX(CASE
                        ...
                        CASE 
                            WHEN STURMADISC.CODDISC IN ('MAT','LPL')
                                AND MAX( STURMADISC.CODTURNO) IN (11,12) THEN 1
                            WHEN STURMADISC.CODDISC NOT IN ('MAT','LPL')
                                AND MAX( STURMADISC.CODTURNO) IN (11,12) THEN 2
                            ELSE 3
                        END AS EH_MAT_LPL
